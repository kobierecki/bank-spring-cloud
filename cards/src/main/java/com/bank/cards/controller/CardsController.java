...
public class CardsController {
    ...
    @Operation(
            ...
            description = "Get build information that is deployed int cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get java version information that is deployed int cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get contact information that about cards microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
